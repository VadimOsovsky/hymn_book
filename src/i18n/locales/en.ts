export default {
  ...
  btn_edit: "Edit",
  btn_save: "Save",
  btn_save_on_device_only: "Save on device only",
  btn_apply: "Apply",
  btn_discard: "Discard",
  ...
  discard_add_message: "You have made changes to the hymn, do you really want to discard them and exit?",
